...
public class Execute {
	...
	//System.out.println("EX");
		...
		else
		{
			...
			/*else if(OF_EX_Latch.getIsNOP())//proceed further if nop
			{	
			...
			else if(OF_EX_Latch.isEX_enable())
			{
				...
				System.out.println("EX " + op1 + " " + op2 + " " + alu_result + " " + instruction);
				System.out.println(op1 + " " + op2 + " " + alu_result + " " + containingProcessor.getRegisterFile().getValue(0));
