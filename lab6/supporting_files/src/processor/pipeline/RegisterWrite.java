...
public class RegisterWrite {
	...
	//System.out.println("RW");
		...
		if(MA_RW_Latch.isRW_Locked()){
			...
			//System.out.println("RW Locked");
		}
		/*else if (MA_RW_Latch.getIsNOP()) {//proceed further if nop instruction
		...
		else if(MA_RW_Latch.isRW_enable())
		{
			...
			//System.out.println("instruction RW	" + instruction);
